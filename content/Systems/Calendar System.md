...
The 12 months fit into 4 seasons:

- **Dendra** (Spring): _Folium_, _Flos_, _Mesis_
- **Pyra** (Summer): _Solis_, _Lux_, _Ardor_
- **Anema** (Fall): _Aureus_, _Venta_, _Thallus_
- **Crya** (Winter): _Ruina_, _Frigus_, _Pagos_

Days are commonly written by stating the month, followed by the day name and date. For example, _Mesis, Solus 15_. However, as the day name and number always correspond, most people omit the name in casual speech or recordkeeping.

An Eden Cycle begins on the first Solus of Folium (Folium 1) and concludes on the last Victus of Pagos (Pagos 28), marking the turn of the year and the renewal of the seasons.